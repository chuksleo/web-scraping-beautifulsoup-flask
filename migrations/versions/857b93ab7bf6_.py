...
Revision ID: 857b93ab7bf6
Revises: 98b1a5c9e520
Create Date: 2019-11-09 12:18:25.967013
...
revision = '857b93ab7bf6'
down_revision = '98b1a5c9e520'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('image_list', sa.String(length=600), nullable=True),
